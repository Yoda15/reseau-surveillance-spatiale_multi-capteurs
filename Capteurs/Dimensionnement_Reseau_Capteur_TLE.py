...
capteurs = [
    ...
    Capteur(52.5200, 13.4050, 34.0, 0.25, 3.2, 60, 120, "Europe/Berlin", "Berlin"),
    Capteur(55.7558, 37.6176, 155.0, 0.25, 3.2, 60, 120, "Europe/Moscow", "Moscow"),
    Capteur(30.0444, 31.2357, 23.0, 0.25, 3.2, 60, 120, "Africa/Cairo", "Cairo"),
    Capteur(40.7128, -74.0060, 10.0, 0.25, 3.2, 60, 120, "America/New_York", "New York"),
    Capteur(-33.8688, 151.2093, 3.0, 0.25, 3.2, 60, 120, "Australia/Sydney", "Sydney"),
    Capteur(-23.5475, -46.6361, 760.0, 0.25, 3.2, 60, 120, "America/Sao_Paulo", "Sao Paulo"),
    Capteur(28.6139, 77.2090, 216.0, 0.25, 3.2, 60, 120, "Asia/Kolkata", "Kolkata"),
    Capteur(35.6895, 139.6917, 5.0, 0.25, 3.2, 60, 120, "Asia/Tokyo", "Tokyo"),
    Capteur(-34.6037, -58.3816, 25.0, 0.25, 3.2, 60, 120, "America/Argentina/Buenos_Aires", "Buenos Aires"),
    Capteur(25.0330, 121.5654, 6.0, 0.25, 3.2, 60, 120, "Asia/Taipei", "Taipei"),
    Capteur(-18.1423, -70.2350, 151.0, 0.25, 3.2, 60, 120, "America/Lima", "Lima"),
    Capteur(51.5074, -0.1278, 35.0, 0.25, 3.2, 60, 120, "Europe/London", "London"),
    Capteur(36.0999, 101.4238, 2275.0, 0.25, 3.2, 60, 120, "Asia/Shanghai", "Shanghai"),
    Capteur(-25.7463, 28.1953, 1753.0, 0.25, 3.2, 60, 120, "Africa/Johannesburg", "Johannesburg"),
    Capteur(37.7749, -122.4194, 16.0, 0.25, 3.2, 60, 120, "America/Los_Angeles", "Los Angeles"),
    Capteur(55.6761, 12.5683, 14.0, 0.25, 3.2, 60, 120, "Europe/Copenhagen", "Copenhagen"),
    Capteur(-36.8485, 174.7633, 5.0, 0.25, 3.2, 60, 120, "Pacific/Auckland", "Auckland"),
    Capteur(1.2833, 103.8333, 8.0, 0.25, 3.2, 60, 120, "Asia/Singapore", "Singapore"),
    Capteur(-34.9287, -56.1645, 43.0, 0.25, 3.2, 60, 120, "America/Montevideo", "Montevideo"),
    Capteur(56.1304, 106.3468, 168.0, 0.25, 3.2, 60, 120, "Asia/Novosibirsk", "Novosibirsk"),
    Capteur(-12.0464, -77.0428, 109.0, 0.25, 3.2, 60, 120, "America/Lima", "Lima"),
    Capteur(32.0853, 34.7818, 35.0, 0.25, 3.2, 60, 120, "Asia/Jerusalem", "Jerusalem"),
    Capteur(37.5665, 126.9780, 38.0, 0.25, 3.2, 60, 120, "Asia/Seoul", "Seoul"),
    Capteur(24.8864, 67.0211, 8.0, 0.25, 3.2, 60, 120, "Asia/Karachi", "Karachi"),
    Capteur(-23.5505, -46.6333, 760.0, 0.25, 3.2, 60, 120, "America/Sao_Paulo", "Sao Paulo"),
    Capteur(43.7728, 11.2564, 50.0, 0.25, 3.2, 60, 120, "Europe/Rome", "Rome"),
    Capteur(22.3193, 114.1694, 25.0, 0.25, 3.2, 60, 120, "Asia/Hong_Kong", "Hong Kong"),
    Capteur(23.1291, 113.2644, 6.0, 0.25, 3.2, 60, 120, "Asia/Macau", "Macau"),
    Capteur(14.5995, -90.6720, 1502.0, 0.25, 3.2, 60, 120, "America/Guatemala", "Guatemala City")
]
        ...
        for num_sensors in range(1, len(periods) + 1):  # Change here to limit the number of sensors to the number of periods
            for sensors in combinations(all_sensors, num_sensors):
                ...
                if can_cover_all_periods:
                    #print(f"{num_sensors} capteur(s) nécessaire(s): {', '.join(sensors)}")
                    f.write("\n" + str(num_sensors) + " capteur(s) necessaire(s) : "+ str(sensors))
